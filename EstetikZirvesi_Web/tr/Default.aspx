<%@ Page Title="" Language="C#" MasterPageFile="~/tr/tr.master" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="EstetikZirvesi_Web.tr.Default" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="tr_Content" runat="server">
                ...
                <fieldset>
                    ...
                    <table class="AlseinTable">
                        ...
                        <tr id="tr_OdaTipi" runat="server" visible="false">
                            ...
                            <td>Oda Tipi</td>
                            <td>
                                <asp:DropDownList ID="ddlOdaTipi" runat="server" onchange="showLoadingIcon();" CssClass="form-control" OnSelectedIndexChanged="ddlOdaTipi_SelectedIndexChanged" AutoPostBack="true" DataSourceID="OleDbOdaTipiListesi" DataTextField="OdaTipi" DataValueField="OdaTipiID" onhange="showLoadingIcon();"></asp:DropDownList>
                            </td>
                        </tr>
                ...
                <fieldset>
                    ...
                    <table class="AlseinTable">
                        ...
                        <tr>
                            ...
                            <td>Kayıt Ücreti</td>
                            <td>
                                <asp:Label ID="lblKatilimciTipiUcret" runat="server" CssClass="form-control"></asp:Label>
                                <asp:HiddenField ID="hfKatilimciUcret" runat="server" Visible="false" />
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:Label ID="lblKonaklamaUcret" runat="server" CssClass="form-control"></asp:Label>
                    ...
                    <fieldset class="mt-3">
                        ...
                        <table class="AlseinTable">
                            <tr>
                                <td>&nbsp;</td>
                                <td>Hesap Adı</td>
                                <td><span class="form-control">Rubikon Turizm Organizasyon Hizmetleri Tic. Ltd. Şti. </span></td>
                            </tr>
                            <tr>
                                <td>&nbsp;</td>
                                <td>Banka Adı </td>
                                <td><span class="form-control">Yapı Kredi Bankası</span></td>
                            </tr>
                            <tr>
                                <td>&nbsp;</td>
                                <td>Şube</td>
                                <td><span class="form-control">Esentepe Büyükdere Caddesi Şubesi </span></td>
                            </tr>
                            <tr>
                                <td>&nbsp;</td>
                                <td>IBAN [ TL ]</td>
                                <td><span class="form-control">TR38 0006 7010 0000 0095 1953 11 </span></td>
                            </tr>

                            <tr>
                                <td>&nbsp;</td>
                                <td>IBAN [ EURO ]</td>
                                <td><span class="form-control">TR26 0006 7010 0000 0095 1978 55</span></td>
                            </tr>
                        </table>
                        <p class="text-center" style="color: #fff">Ödemenizi takip edebilmemiz için, dekontunuzu <a href="mailto:estetikzirvesi@rubikonturizm.com ">estetikzirvesi@rubikonturizm.com</a> adresine sipariş numarası içerecek şekilde göndermeyi unutmayınız.</p>
                    </fieldset>
                </asp:Panel>

                <div style="background-color: #BE9240; color: white; border: 1px solid #BE9240; padding: 15px; font-weight: bold; font-size: 1em; text-align: left; margin-top: 10px;">
                    <div style="text-align: center;">İPTAL VE İADE ŞARTLARI</div>
                    <br>
                    • <b>16 Haziran 2025</b> tarihine kadar yapılan iptal taleplerinde banka masrafları kesildikten sonra iade gerçekleştirilecektir.<br>
                    <br>
                    • <b>16 Haziran 2025</b>’ten sonra yapılacak iptallerde herhangi bir iade yapılamayacaktır. Sadece isim değişiklikleri yapılabilecektir.<br>
                    <br>
                    • Bütün iadeler kongre sonrasında gerçekleştirilecektir.
                </div>
    ...
    <asp:SqlDataSource runat="server" ID="OleDbKatilimciTipiListesi" ConnectionString='<%$ ConnectionStrings:EstetikZirvesi_Web %>' ProviderName='<%$ ConnectionStrings:EstetikZirvesi_Web.ProviderName %>' SelectCommand="SELECT [KatilimciTipiDilTablosu].* FROM [KatilimciTipiDilTablosu] INNER JOIN [KatilimciTipiTablosu] ON [KatilimciTipiDilTablosu].[KatilimciTipiID] = [KatilimciTipiTablosu].[KatilimciTipiID] WHERE [KatilimciTipiDilTablosu].[DilID] = 'tr' ORDER BY [KatilimciTipiTablosu].[Sira]"></asp:SqlDataSource>

    <asp:SqlDataSource runat="server" ID="OleDbOtelListesi" ConnectionString='<%$ ConnectionStrings:EstetikZirvesi_Web %>' ProviderName='<%$ ConnectionStrings:EstetikZirvesi_Web.ProviderName %>' SelectCommand="SELECT * FROM [OtelTablosu] ORDER BY Sira"></asp:SqlDataSource>

    <asp:SqlDataSource runat="server" ID="OleDbOdaTipiListesi" ConnectionString='<%$ ConnectionStrings:EstetikZirvesi_Web %>' ProviderName='<%$ ConnectionStrings:EstetikZirvesi_Web.ProviderName %>' SelectCommand="SELECT [OdaTipiDilTablosu].* FROM [OdaTipiDilTablosu] INNER JOIN [OdaTipiTablosu] ON [OdaTipiDilTablosu].[OdaTipiID] = [OdaTipiTablosu].[OdaTipiID] WHERE [OdaTipiDilTablosu].[DilID] = 'tr' AND [OdaTipiTablosu].[OtelID] = ? ORDER BY [OdaTipiTablosu].[Sira]">
        <SelectParameters>
            <asp:ControlParameter ControlID="ddlOtel" PropertyName="SelectedValue" Name="?" DefaultValue="0" Type="Int32" />
        </SelectParameters>
    </asp:SqlDataSource>

    <asp:SqlDataSource runat="server" ID="OleDbTransferTipiListesi" ConnectionString='<%$ ConnectionStrings:EstetikZirvesi_Web %>' ProviderName='<%$ ConnectionStrings:EstetikZirvesi_Web.ProviderName %>' SelectCommand="SELECT [TransferTipiDilTablosu].* FROM [TransferTipiDilTablosu] INNER JOIN [TransferTipiTablosu] ON [TransferTipiDilTablosu].[TransferTipiID] = [TransferTipiTablosu].[TransferTipiID] WHERE [TransferTipiDilTablosu].[DilID] = 'tr' ORDER BY Sira"></asp:SqlDataSource>

    <asp:SqlDataSource runat="server" ID="OleDbKursListesi" ConnectionString='<%$ ConnectionStrings:EstetikZirvesi_Web %>' ProviderName='<%$ ConnectionStrings:EstetikZirvesi_Web.ProviderName %>' SelectCommand="SELECT [KursTipiDilTablosu].* FROM [KursTipiDilTablosu] INNER JOIN [KursTipiTablosu] ON [KursTipiDilTablosu].[KursTipiID] = [KursTipiTablosu].[KursTipiID] WHERE [KursTipiDilTablosu].[DilID] = 'tr' ORDER BY Sira"></asp:SqlDataSource>

    <asp:SqlDataSource runat="server" ID="OleDbEtkinlikListesi" ConnectionString='<%$ ConnectionStrings:EstetikZirvesi_Web %>' ProviderName='<%$ ConnectionStrings:EstetikZirvesi_Web.ProviderName %>' SelectCommand="SELECT [EtkinlikDilTablosu].* FROM [EtkinlikDilTablosu] INNER JOIN [EtkinlikTablosu] ON [EtkinlikTablosu].[EtkinlikID] = [EtkinlikDilTablosu].[EtkinlikID] WHERE [EtkinlikDilTablosu].[DilID] = 'tr' ORDER BY Sira"></asp:SqlDataSource>

    <asp:SqlDataSource runat="server" ID="OleDbOdemeTipiListesi" ConnectionString='<%$ ConnectionStrings:EstetikZirvesi_Web %>' ProviderName='<%$ ConnectionStrings:EstetikZirvesi_Web.ProviderName %>' SelectCommand="SELECT * FROM [OdemeTipiDilTablosu] WHERE [DilID] = 'tr'"></asp:SqlDataSource>
</asp:Content>
