    ...
    public partial class OdemeTablosuIslemler : OdemeTablosuIslemlerBase
    {
        ...
        public SurecVeriModel<OdemeTablosuModel> KayitBilgisi(string OdemeID, string DilID)
        {
            int
               ...
               KatilimciTipiIX = KatilimciIX + KatilimciTablosuModel.OzellikSayisi,
               KatilimciTipiDilIX = KatilimciTipiIX + KatilimciTipiTablosuModel.OzellikSayisi,

               KonaklamaIX = KatilimciTipiDilIX + KatilimciTipiDilTablosuModel.OzellikSayisi,
               OdaTipiIX = KonaklamaIX + KonaklamaTablosuModel.OzellikSayisi,
            ...
            if (SModel.Sonuc.Equals(Sonuclar.Basarili))
            {
                while (SModel.Reader.Read())
                {
                    if (KayitBilgisiAl(OdemeIX, SModel.Reader).Sonuc.Equals(Sonuclar.Basarili))
                    {
                        ...
                        SDataModel.Veriler.KatilimciBilgisi.KatilimciTipiBilgisi = new KatilimciTipiTablosuIslemler().KayitBilgisiAl(KatilimciTipiIX, SModel.Reader).Veriler;
                        SDataModel.Veriler.KatilimciBilgisi.KatilimciTipiBilgisi.KatilimciTipiDilBilgisi = new List<KatilimciTipiDilTablosuModel> { new KatilimciTipiDilTablosuIslemler().KayitBilgisiAl(KatilimciTipiDilIX, SModel.Reader).Veriler };
                        ...
                        SDataModel.Veriler.KatilimciBilgisi.KonaklamaBilgisi.OdaTipiBilgisi = new OdaTipiTablosuIslemler().KayitBilgisiAl(OdaTipiIX, SModel.Reader).Veriler;
                        SDataModel.Veriler.KatilimciBilgisi.KonaklamaBilgisi.OdaTipiBilgisi.OdaTipiDilBilgisi = new List<OdaTipiDilTablosuModel> { new OdaTipiDilTablosuIslemler().KayitBilgisiAl(OdaTipiDilIX, SModel.Reader).Veriler };

                        SDataModel.Veriler.KatilimciBilgisi.KonaklamaBilgisi.OdaTipiBilgisi.OtelBilgisi = new OtelTablosuIslemler().KayitBilgisiAl(OtelIX, SModel.Reader).Veriler;
                ...
                while (SModel.Reader.Read())
                {
                    ...
                    if (OModel is null)
                    {
                        if (KayitBilgisiAl(OdemeIX, SModel.Reader).Sonuc.Equals(Sonuclar.Basarili))
                        {
                            ...
                            OModel.KatilimciBilgisi.KatilimciTipiBilgisi = new KatilimciTipiTablosuIslemler().KayitBilgisiAl(KatilimciTipiIX, SModel.Reader).Veriler;
                            OModel.KatilimciBilgisi.KatilimciTipiBilgisi.KatilimciTipiDilBilgisi = new List<KatilimciTipiDilTablosuModel> { new KatilimciTipiDilTablosuIslemler().KayitBilgisiAl(KatilimciTipiDilIX, SModel.Reader).Veriler };
                            OModel.KatilimciBilgisi.KonaklamaBilgisi = new KonaklamaTablosuIslemler().KayitBilgisiAl(KonaklamaIX, SModel.Reader).Veriler;
                            OModel.KatilimciBilgisi.KonaklamaBilgisi.OdaTipiBilgisi = new OdaTipiTablosuIslemler().KayitBilgisiAl(OdaTipiIX, SModel.Reader).Veriler;
                            OModel.KatilimciBilgisi.KonaklamaBilgisi.OdaTipiBilgisi.OdaTipiDilBilgisi = new List<OdaTipiDilTablosuModel> { new OdaTipiDilTablosuIslemler().KayitBilgisiAl(OdaTipiDilIX, SModel.Reader).Veriler };
                            OModel.KatilimciBilgisi.KonaklamaBilgisi.OdaTipiBilgisi.OtelBilgisi = new OtelTablosuIslemler().KayitBilgisiAl(OtelIX, SModel.Reader).Veriler;
