...
namespace VeritabaniIslemMerkeziBase
{
	public abstract class DilTablosuIslemlerBase
	{
		...
		protected List<DilTablosuModel> VeriListe;

		protected SurecBilgiModel SModel;
		protected SurecVeriModel<DilTablosuModel> SDataModel;
		protected SurecVeriModel<IList<DilTablosuModel>> SDataListModel;
