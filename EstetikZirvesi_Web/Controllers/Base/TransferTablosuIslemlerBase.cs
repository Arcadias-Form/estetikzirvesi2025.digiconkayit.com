...
namespace VeritabaniIslemMerkeziBase
{
	public abstract class TransferTablosuIslemlerBase
	{
		...
		protected List<TransferTablosuModel> VeriListe;

		protected SurecBilgiModel SModel;
		protected SurecVeriModel<TransferTablosuModel> SDataModel;
		protected SurecVeriModel<IList<TransferTablosuModel>> SDataListModel;
