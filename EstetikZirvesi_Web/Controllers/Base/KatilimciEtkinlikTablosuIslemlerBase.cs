...
namespace VeritabaniIslemMerkeziBase
{
	public abstract class KatilimciEtkinlikTablosuIslemlerBase
	{
		...
		protected List<KatilimciEtkinlikTablosuModel> VeriListe;

		protected SurecBilgiModel SModel;
		protected SurecVeriModel<KatilimciEtkinlikTablosuModel> SDataModel;
		protected SurecVeriModel<IList<KatilimciEtkinlikTablosuModel>> SDataListModel;
