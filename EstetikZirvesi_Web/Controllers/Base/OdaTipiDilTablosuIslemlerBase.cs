...
namespace VeritabaniIslemMerkeziBase
{
	public abstract class OdaTipiDilTablosuIslemlerBase
	{
		...
		protected List<OdaTipiDilTablosuModel> VeriListe;

		protected SurecBilgiModel SModel;
		protected SurecVeriModel<OdaTipiDilTablosuModel> SDataModel;
		protected SurecVeriModel<IList<OdaTipiDilTablosuModel>> SDataListModel;
