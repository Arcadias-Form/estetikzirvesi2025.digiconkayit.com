...
namespace VeritabaniIslemMerkeziBase
{
	public abstract class OtelTablosuIslemlerBase
	{
		...
		protected List<OtelTablosuModel> VeriListe;

		protected SurecBilgiModel SModel;
		protected SurecVeriModel<OtelTablosuModel> SDataModel;
		protected SurecVeriModel<IList<OtelTablosuModel>> SDataListModel;
