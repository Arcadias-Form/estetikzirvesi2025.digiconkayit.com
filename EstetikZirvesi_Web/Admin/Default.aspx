...
<head>
    ...
    <meta name="author" content="Altay Serhat Ýnan (Arcadias Tech) [serhat@arcadiastech.com / +90 506 953 14 36 / +90 507 574 16 40]" />
                                        ...
                                        <asp:Login ID="LGGiris" runat="server" Style="width: 100%" OnLoginError="LGGiris_LoginError">
                                            <LayoutTemplate>
                                                <div class="input-group mb-3">
                                                    <asp:TextBox ID="UserName" CssClass="form-control" runat="server" placeholder="Kullanýcý Adýný"></asp:TextBox>
                                                    <div class="input-group-append">
                                                        <span class="input-group-text"><i class="zmdi zmdi-account-circle"></i></span>
                                                    </div>
                                                </div>
                                                <div class="input-group mb-3">
                                                    <asp:TextBox ID="Password" TextMode="Password" CssClass="form-control" runat="server" placeholder="Þifreniz"></asp:TextBox>
                                                    <div class="input-group-append">
                                                ...
                                                <asp:UpdatePanel ID="UPnlGiris" runat="server" class="text-center">
                                                    <ContentTemplate>
                                                        <asp:LinkButton ID="lnkbtnGiris" CommandName="Login" runat="server" CssClass="btn btn-primary btn-block waves-effect waves-light" OnClientClick="$(this).css('display', 'none'); $(Yukleniyor).css('display', 'inline-block');">
                                                            <i class="fa fa-check"></i>&nbsp;Giriþ Yap
                                                        </asp:LinkButton>
