<%@ Page Title="" Language="C#" MasterPageFile="~/en/en.master" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="EstetikZirvesi_Web.en.Default" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="en_Head" runat="server">
    ...
    <script type="text/javascript">
        ...
        datePickerOption.placeholder = "Please click for pickup date.";
...
<asp:Content ID="Content2" ContentPlaceHolderID="en_Content" runat="server">
                ...
                <fieldset>
                    ...
                    <table class="AlseinTable">
                        <tr>
                            ...
                            <td>
                                <asp:DropDownList ID="ddlKatilimciTipi" runat="server" CssClass="form-control" AutoPostBack="true" DataSourceID="OleDbKatilimciTipiListesi" DataTextField="KatilimciTipi" DataValueField="KatilimciTipiID" onchange="showLoadingIcon();" OnSelectedIndexChanged="FiyatHesaplama"></asp:DropDownList>
                            </td>
                        </tr>
                        <tr>
                            <td>*</td>
    ...
    <asp:SqlDataSource runat="server" ID="OleDbOdemeTipiListesi" ConnectionString='<%$ ConnectionStrings:EstetikZirvesi_Web %>' ProviderName='<%$ ConnectionStrings:EstetikZirvesi_Web.ProviderName %>' SelectCommand="SELECT * FROM [OdemeTipiDilTablosu] WHERE [DilID] = 'en'"></asp:SqlDataSource>
</asp:Content>
