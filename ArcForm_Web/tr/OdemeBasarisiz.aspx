<%@ Page Title="" Language="C#" MasterPageFile="~/tr/tr.master" AutoEventWireup="true" CodeBehind="OdemeBasarisiz.aspx.cs" Inherits="ArcForm_Web.tr.OdemeBasarisiz" %>
    ...
    <div class="row">
        <div class="col-lg-12 text-center">
            <fieldset style="color: red">
                ...
                <p style="color: black">
                    <u>Sipariş No:</u> <asp:Label ID="lblOdemeID" runat="server" Font-Bold="true"></asp:Label>
                </p>
            </fieldset>
        </div>
    </div>
