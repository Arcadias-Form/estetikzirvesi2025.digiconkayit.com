<%@ Page Title="" Language="C#" MasterPageFile="~/en/en.master" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="ArcForm_Web.en.Default" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="en_Content" runat="server">
    ...
    <asp:SqlDataSource runat="server" ID="OleDbOdaTipiListesi" ConnectionString='<%$ ConnectionStrings:ArcForm_Web %>' ProviderName='<%$ ConnectionStrings:ArcForm_Web.ProviderName %>' SelectCommand="SELECT [OdaTipiDilTablosu].* FROM [OdaTipiDilTablosu] INNER JOIN [OdaTipiTablosu] ON [OdaTipiDilTablosu].[OdaTipiID] = [OdaTipiTablosu].[OdaTipiID] WHERE [OdaTipiDilTablosu].[DilID] = 'en' AND [OdaTipiTablosu].[OtelID] = ? ORDER BY [OdaTipiTablosu].[Sira]">
        <SelectParameters>
