    ...
    public class MailGonderimIslemleri
    {
        ...
        public void KayitBilgilendirme(OdemeTablosuModel YeniKayit, string DilID = "tr")
        {
            using (MimeMessage mm = new MimeMessage())
            {
                ...
                //mm.Bcc.Add(new MailboxAddress("ARC 2024", "test@arkadyas.com"));
                ...
                switch (DilID)
                {
                    ...
                    case "tr":
                        ...
                        OutlookContent = new StringBuilder()
                            ...
                            .Append($"<tr><td>Katılımcı Tipi</td><td>{YeniKayit.KatilimciBilgisi.KatilimciTipiBilgisi.KatilimciTipiDilBilgisi.First().KatilimciTipi}</td></tr>")
