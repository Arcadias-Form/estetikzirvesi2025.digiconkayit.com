...
namespace VeritabaniIslemMerkeziBase
{
	public abstract class KatilimciKursTablosuIslemlerBase
	{
		...
		protected List<KatilimciKursTablosuModel> VeriListe;

		protected SurecBilgiModel SModel;
		protected SurecVeriModel<KatilimciKursTablosuModel> SDataModel;
		protected SurecVeriModel<IList<KatilimciKursTablosuModel>> SDataListModel;
