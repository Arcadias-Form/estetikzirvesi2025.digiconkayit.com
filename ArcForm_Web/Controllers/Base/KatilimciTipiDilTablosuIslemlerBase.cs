...
namespace VeritabaniIslemMerkeziBase
{
	public abstract class KatilimciTipiDilTablosuIslemlerBase
	{
		...
		protected List<KatilimciTipiDilTablosuModel> VeriListe;

		protected SurecBilgiModel SModel;
		protected SurecVeriModel<KatilimciTipiDilTablosuModel> SDataModel;
		protected SurecVeriModel<IList<KatilimciTipiDilTablosuModel>> SDataListModel;
