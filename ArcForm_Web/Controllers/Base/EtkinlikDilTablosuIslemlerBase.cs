...
namespace VeritabaniIslemMerkeziBase
{
	public abstract class EtkinlikDilTablosuIslemlerBase
	{
		...
		protected List<EtkinlikDilTablosuModel> VeriListe;

		protected SurecBilgiModel SModel;
		protected SurecVeriModel<EtkinlikDilTablosuModel> SDataModel;
		protected SurecVeriModel<IList<EtkinlikDilTablosuModel>> SDataListModel;
