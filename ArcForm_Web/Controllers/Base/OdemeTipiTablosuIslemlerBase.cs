...
namespace VeritabaniIslemMerkeziBase
{
	public abstract class OdemeTipiTablosuIslemlerBase
	{
		...
		protected List<OdemeTipiTablosuModel> VeriListe;

		protected SurecBilgiModel SModel;
		protected SurecVeriModel<OdemeTipiTablosuModel> SDataModel;
		protected SurecVeriModel<IList<OdemeTipiTablosuModel>> SDataListModel;
