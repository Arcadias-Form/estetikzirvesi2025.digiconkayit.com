...
namespace VeritabaniIslemMerkeziBase
{
	public abstract class OdemeTipiDilTablosuIslemlerBase
	{
		...
		protected List<OdemeTipiDilTablosuModel> VeriListe;

		protected SurecBilgiModel SModel;
		protected SurecVeriModel<OdemeTipiDilTablosuModel> SDataModel;
		protected SurecVeriModel<IList<OdemeTipiDilTablosuModel>> SDataListModel;
