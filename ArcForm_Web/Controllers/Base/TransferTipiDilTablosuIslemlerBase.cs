...
namespace VeritabaniIslemMerkeziBase
{
	public abstract class TransferTipiDilTablosuIslemlerBase
	{
		...
		protected List<TransferTipiDilTablosuModel> VeriListe;

		protected SurecBilgiModel SModel;
		protected SurecVeriModel<TransferTipiDilTablosuModel> SDataModel;
		protected SurecVeriModel<IList<TransferTipiDilTablosuModel>> SDataListModel;
