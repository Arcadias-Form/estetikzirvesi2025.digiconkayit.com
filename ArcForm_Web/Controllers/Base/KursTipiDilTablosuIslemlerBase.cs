...
namespace VeritabaniIslemMerkeziBase
{
	public abstract class KursTipiDilTablosuIslemlerBase
	{
		...
		protected List<KursTipiDilTablosuModel> VeriListe;

		protected SurecBilgiModel SModel;
		protected SurecVeriModel<KursTipiDilTablosuModel> SDataModel;
		protected SurecVeriModel<IList<KursTipiDilTablosuModel>> SDataListModel;
